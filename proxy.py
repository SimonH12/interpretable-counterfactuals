...
def knn_classify(dataframe, samples, to_predict, df_mad): 
    ...
    for i in range(len(samples.index)):
        ...
        prediction.append(dataframe.loc[nearest_neigbors[0]][to_predict]) # works only for 1-NN
    return prediction
...
def output_to_csv(number_of_cfs, name_of_dataset, features_varied, f1_abno, f1_gene, f1_prox, f1_obta, f1_all, f1_dice, f1_rand, f1_dice_3, folder_out=r"real_world_data\out"):
    ...
    for rep in range(reps):
        for r in range(rounds):
            ...
            try:
                ...
                counterfactuals = counterfactuals.drop(['abnormality', 'generality'], axis='columns') # put this line in apply.py instead
...
if __name__ == '__main__':
    ...
    # path_adult = r"C:datasets\adult_standard.csv"
    ...
    target_class = 1
    path_iris = r"datasets\toy_dataset_iris_3d.csv"
    ...
    # target_class_name = 'match'
    # target_class = 1
    # path_dating = r"datasets\dating_balanced.csv"
    # ordering_features_dating = {
    #     'attractiveness': ['slightly_below', 'below', 'average', 'sligthly_above', 'above']
    # }
    # # to_vary = ['gender', 'age', 'race', 'age_partner', 'attractiveness', 'sincerity', 'intelligence', 'funny', 'ambitious', 'shared_interests', 'race_partner', 'field_study']
